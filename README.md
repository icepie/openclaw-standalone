...
[![Build](https://github.com/icepie/openclaw-standalone/actions/workflows/build.yml/badge.svg)](https://github.com/icepie/openclaw-standalone/actions/workflows/build.yml)
...
1. 从 [Releases](https://github.com/icepie/openclaw-standalone/releases) 下载 `openclaw-*-win-x64-setup.exe`
2. 双击运行安装向导
...
1. 从 [Releases](https://github.com/icepie/openclaw-standalone/releases) 下载对应平台的压缩包
2. 解压到任意目录
3. 将该目录添加到系统 PATH
